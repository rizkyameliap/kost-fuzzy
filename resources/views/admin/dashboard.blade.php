...
<div class="row mt-4">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <p>Klik tombol di bawah untuk memproses perhitungan fuzzy SAW berdasarkan data kost dan kriteria yang ada.</p>
                <form action="{{ route('admin.calculate.saw') }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="btn btn-warning btn-lg">
                        <i class="fas fa-play me-2"></i>Jalankan Perhitungan SAW
                    </button>
                </form>
                <a href="{{ route('admin.results') }}" class="btn btn-info btn-lg ms-2">
